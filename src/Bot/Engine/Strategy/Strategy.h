...
inline constexpr float ACTION_IDLE = 0.0f;
inline constexpr float ACTION_BG = 1.0f;
inline constexpr float ACTION_DEFAULT = 5.0f;
inline constexpr float ACTION_NORMAL = 10.0f;
inline constexpr float ACTION_HIGH = 20.0f;
inline constexpr float ACTION_MOVE = 30.0f;
inline constexpr float ACTION_INTERRUPT = 40.0f;
inline constexpr float ACTION_DISPEL = 50.0f;
inline constexpr float ACTION_RAID = 60.0f;
inline constexpr float ACTION_LIGHT_HEAL = 10.0f;
inline constexpr float ACTION_MEDIUM_HEAL = 20.0f;
inline constexpr float ACTION_CRITICAL_HEAL = 30.0f;
inline constexpr float ACTION_EMERGENCY = 90.0f;
